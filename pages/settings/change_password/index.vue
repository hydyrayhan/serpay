  ...
  <div class="container CPContainer">
    <div class="CP">
      ...
      <div class="CP_input">
        ...
        <input class="padding" type="password" id="name">
      ...
      <div class="CP_input">
        ...
        <input class="padding" type="password" id="name1">
      ...
      <div class="CP_input">
        ...
        <input class="padding" type="password" id="name2">
      ...
      <button class="send">{{$t('save')}}</button>
    </div>
