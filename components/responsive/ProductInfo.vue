<template>
  <div class="productInfoComponent">
    ...
    <div class="gallery" v-if="gallery">
      ...
      <div class="bigImage"><img src="~/assets/images/delete/product.png" alt=""></div>
      <div class="smallImages">
        <div class="smallImages_image active" @click="galleryImage(0)">
          <img src="~/assets/images/delete/product.png" alt="">
        </div>
        <div class="smallImages_image" @click="galleryImage(1)">
          <img src="~/assets/images/delete/product3.png" alt="">
        </div>
        <div class="smallImages_image" @click="galleryImage(2)">
          <img src="~/assets/images/delete/product.png" alt="">
        </div>
        <div class="smallImages_image" @click="galleryImage(3)">
          <img src="~/assets/images/delete/product3.png" alt="">
        </div>
      </div>
    </div>
